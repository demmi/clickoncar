"""
Django settings for clickoncar project.
...
SECRET_KEY = 'django-insecure-*nzw-+rjew)tpi^sfi+ft7@vkvc$aw$)$lx6(lkob54k%y!7wb'
...
WSGI_APPLICATION = 'clickoncar.wsgi.application'
